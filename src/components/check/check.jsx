  ...
  return (
    <div className="latestMovies">
        ...
        <div className="layout-change-buttons">
            <BsFillGrid3X3GapFill className='layout1' style={styleLayout1} onClick={() => setLayoutChange(false)}/>
            <FaBars className='layout2' style={styleLayout2} onClick={() => setLayoutChange(true)}/>
        </div>
        <div className="results">
            {
                ...
                <div className="result-layout1 fadeIn" >
                    ...
                    {
                        (latestmoviedata) ? 
                        latestmoviedata.map((element) => <div className="card" key={element.id}>
